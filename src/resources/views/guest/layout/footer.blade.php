        ...
        <div class="sigma_info-wrapper style-26 mb-5">
            <div class="sigma_info style-26">
                ...
                <div class="sigma_info-description">
                    <p>Our Address</p>
                    <p class="secondary-color"><b>Drive Chicago, IL 60607</b>
                    </p>
                </div>
            </div>
            <div class="sigma_info style-26">
                ...
                <div class="sigma_info-description">
                    <p>Call Us</p>
                    <p class="secondary-color"><b>360-779-2228</b>
                    </p>
                </div>
            </div>
            <div class="sigma_info style-26">
                ...
                <div class="sigma_info-description">
                    <p>Our Mail</p>
                    <p class="secondary-color"><b>yourname@mail.com</b>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="sigma_footer-widget">
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <p class="mb-0">Message content goes here.</p>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="sigma_footer-widget">
                        ...
                        <form class="form_validate ajax_submit form_alert" action="subscribe_email" method="post">
                            ...
                            <button type="submit" class="mt-3 btn-block">Subscribe</button>
